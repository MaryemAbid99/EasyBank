    ...
    async refreshToken(refreshToken) {
        ...
        try {
            ...
            if (!user || !user.refreshToken)
                throw new common_1.ForbiddenException('Refresh token invalide ou inexistant');
            const isValid = await bcrypt.compare(refreshToken, user.refreshToken || '');
            if (!isValid)
                throw new common_1.ForbiddenException('Refresh token invalide');
            ...
            throw new common_1.ForbiddenException('Refresh token expiré ou invalide');
        }
    }
    async logout(userId) {
